...
public class TestGame {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        madzia.components.sprite = new Sprite(new Vector2(-50,-50),new Vector2(100,100),Color.PINK);
        madzia.position=new Vector2(300,300);
        allir.components.script=new TestScript();
        allir.components.sprite=new Sprite(new Vector2(-50,-50),new Vector2(100,100),Color.WHITE);

        ((TestScript) allir.components.script).player=1;
        ((TestScript) madzia.components.script).player=2;

        allir.components.physicalBody=new TestColider(new Vector2(-50,-50),new Vector2(100,100));
        madzia.components.physicalBody=new TestColider(new Vector2(-50,-50),new Vector2(100,100));
